  ...
  <head>
    ...
    <style>
      * {
      ...
      p{
        margin: 10px 0 5px 0; /* p tag automatically takes margin of 16px so i reset it tp margin top 10px and all others to 0   */
      }
  ...
  <body>
    <div class="main">
      <form id="form" method="POST">
        <input type="text" name = "name"  placeholder="UserName or Email" id="userName" />
